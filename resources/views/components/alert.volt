{# TAVPblocks Alert Component #}
{# Usage: {% include 'components/alert.volt' with {'type': 'success', 'message': 'Saved successfully!'} %} #}
...
<div class="rounded-md border p-4 {{ typeClasses[type] }}" role="alert">
    <div class="flex">
        ...
        <div class="ml-3">
            <p class="text-sm font-medium">{{ message|default('') }}</p>
        </div>
        {% if dismissible %}
